        ...
        <div>
            <div className=" bg-[#F5F5FF]">
                <div className="max-w-[1200px] mx-auto px-3 py-[80px]">
                    <h2 data-aos-duration="2000" data-aos="fade-down" className="max-w-[534px] text-center text-slate-900 text-[25px] md:text-[40px] mx-auto font-bold font-['Montserrat'] capitalize leading-[30px] md:leading-[60px] tracking-wide">
                        Subscribe Newsletter & get letest news
                    </h2>
                    <form data-aos-duration="2000" data-aos="fade-down" className="max-w-[493px] min-h-[70px] mt-[40px] pl-5 pr-[11px] py-[11px] bg-white rounded-[150px]  mx-auto shadow border  items-center flex justify-between ">
